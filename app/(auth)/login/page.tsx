    ...
    <div className="flex w-full items-center justify-center h-screen">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-xl ">
        <div className="flex items-center justify-center mb-6">
          ...
          <h1 className="text-4xl max-sm:text-3xl font-extrabold text-gray-800">
            Login
          </h1>
        </div>
        <p className="text-xl text-gray-600 text-center max-sm:text-lg mb-4">
          Welcome Back
        </p>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input
              ...
              type="email"
              id="email"
              className={`w-full border-2 rounded-md p-2 text-gray-700 focus:outline-none ${
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              <input
                ...
                id="password"
                className={`w-full border-2 rounded-md p-2 text-gray-700 focus:outline-none pr-10 ${
          ...
          <div className="flex justify-around mt-4">
            <Link href="/forgot-password">
              <p className="text-sm text-blue-500 hover:text-blue-600 transition duration-300">
                Forgot Password?
              </p>
            </Link>
