  ...
  return (
    <section className=" flex flex-col gap-5  w-full pt-2">
      ...
      <div className="relative flex flex-wrap  items-center  justify-around  gap-5 w-full   pr-7 no-scrollbar ">
        ...
        <div className="relative min-w-[10rem]   flex flex-col items-center justify-center  p-4 border rounded-xl">
          {/* total balaced  */}
          <p className=" font-medium ">Total Balance</p>
          <h1 className="text-2xl font-bold">
            45 <span>days</span>
      ...
      <div className="flex flex-col lg:flex-row  border  w-full h-full">
        <div className="flex flex-col gap-10 min-w-[24rem]   w-full md:w-fit px-4 py-4">
          {/* Charts of status */}
          <div className="w-full relative">
            <h1 className="sm:text-4xl text-2xl font-bold ">Status of Leaves</h1>
            <p className="sm:text-1xl">This is the status of last 50 days</p>
          </div>
          <ChartDemo className="md:w-[30rem] text-center w-[15rem] md:h-[25rem] " />
        </div>
        <div className="flex-1 flex gap-5 flex-col px-4  py-4">
          {/* recent applied */}
          <div>
