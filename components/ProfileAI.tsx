  ...
  return (
    <div>
      <div className="max-h-[92vh] overflow-scroll no-scrollbar">
        ...
        <h2 className="text-2xl font-bold max-md:text-xl mb-2 text-blue-600">Department Information</h2>
          <div className="flex mb-2">
            <span className="sm:w-1/3 w-3/4 text-gray-600 dark:text-gray-200/70 text-lg max-md:text-sm">Department:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">CSE</span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 w-3/4 text-gray-600 dark:text-gray-200/70 text-lg max-md:text-sm">Department ID:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{profile.professional.departmentId}</span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 w-3/4 text-gray-600 dark:text-gray-200/70 text-lg max-md:text-sm">Designation:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{profile.professional.designation}</span>
          </div>
        </div>
        </div>
        <div className="mb-3 border sm:p-2 sm:pl-8 p-2 shadow-md dark:shadow-white  rounded-lg">
          <h2 className="text-2xl font-bold max-md:text-xl text-blue-600 mb-2">Personal Information</h2>
          <div className="flex mb-2">
            <span className="sm:w-1/3 w-3/4 text-lg max-md:text-sm text-gray-600 dark:text-gray-200/70">Name:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">
              {profile.personal.name.firstName} {profile.personal.name.lastName}
            </span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 w-3/4 text-lg max-md:text-sm  text-gray-600 dark:text-gray-200/70">Date of Birth:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{dateFormat(profile.personal.dob)}</span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3  w-3/4 text-lg max-md:text-sm text-gray-600 dark:text-gray-200/70">Gender:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{profile.personal.gender}</span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 text-lg max-md:text-sm w-3/4 text-gray-600 dark:text-gray-200/70">Phone No:</span>
            <span className=" sm:w-2/3 text-lg max-md:text-sm w-full">
                {profile.personal.contact.phone}    
            </span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 text-lg max-md:text-sm w-3/4 text-gray-600 dark:text-gray-200/70">Email:</span>
            <span className=" sm:w-2/3 text-lg max-md:text-sm w-full">
                {profile.personal.contact.email}
              </span>
          </div>
          ...
          <div className="flex mb-2">
            <span className="sm:w-1/3 w-3/4 text-lg max-md:text-sm text-gray-600 dark:text-gray-200/70">Address:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{profile.personal.address}</span>
          </div>
        </div>
        <div className="mb-3 border shadow-md dark:shadow-white sm:p-4 sm:pl-8 p-2 rounded-lg ">
          <h2 className="text-2xl font-bold max-md:text-xl mb-2 text-blue-600">Experience Information</h2>
          {profile.experience.map((experience, index) => (
            <div key={index} className="mb-4">
             
              <div className="flex mb-2">
                <span className="sm:w-1/3 text-lg max-md:text-sm w-3/4 text-gray-600 dark:text-gray-200/70">Job Title:</span>
                <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{experience.jobTitle}</span>
              </div>
              <div className="flex  mb-2">
                <span className="sm:w-1/3 text-lg max-md:text-sm w-3/4 text-gray-600 dark:text-gray-200/70">Job Description:</span>
                <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{experience.responsibilities}</span>
              </div>
            </div>
          ))}
        </div>
        <div className="sm:mb-3 border shadow-md dark:shadow-white  sm:p-4  sm:pl-8 p-2 rounded-lg">
          <h2 className="text-2xl max-md:text-xl font-bold  text-blue-600 mb-2">Education Information</h2>
          <div className="flex mb-2">
            <span className="sm:w-1/3 text-lg max-md:text-sm w-2/3 text-gray-600 dark:text-gray-200/70">Qualification:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">
              {profile.education.highestQualification}
            </span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 text-lg max-md:text-sm w-2/3 text-gray-600 dark:text-gray-200/70">University:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{profile.education.university}</span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 text-lg max-md:text-sm w-2/3 text-gray-600 dark:text-gray-200/70">Year of Passing:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">
              {dateFormat(profile.education.yearOfPassing)}
            </span>
          </div>
          <div className="flex mb-2">
            <span className="sm:w-1/3 text-lg max-md:text-sm w-2/3 text-gray-600 dark:text-gray-200/70">Specialization:</span>
            <span className="sm:w-2/3 text-lg max-md:text-sm w-full">{profile.education.specialization}</span>
          </div>
        </div>
      </div>
    </div>
